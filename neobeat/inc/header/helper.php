...
if ( ! function_exists( 'neobeat_load_page_header' ) ) {
	/**
	...
	add_action( 'neobeat_action_page_header_template', 'neobeat_load_page_header' );
}

if ( ! function_exists( 'neobeat_register_navigation_menus' ) ) {
	/**
	 * Function which registers navigation menus
	 */
	function neobeat_register_navigation_menus() {
		$navigation_menus = apply_filters( 'neobeat_filter_register_navigation_menus', array( 'main-navigation' => esc_html__( 'Main Navigation', 'neobeat' ) ) );
	...
	add_action( 'neobeat_action_after_include_modules', 'neobeat_register_navigation_menus' );
}

if ( ! function_exists( 'neobeat_get_header_logo_image' ) ) {
	/**
